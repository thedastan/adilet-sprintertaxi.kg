				...
				<Container maxW={CONTAINER_WIDTH}>
					<Box
						...
						<Text
							...
							w={{ lg: "80%", base: "100%" }}
							textAlign="center"
							fontSize={{ lg: 42, base: 33 }}
							color="white"
							bg="orange">
							такси портер бишкек грузовые перевозки по Кыргызстану и за ее
							пределы.
						</Text>
						<Text
							p={{ lg: 10, base: 5 }}
							...
							w={{ lg: "45%", base: "100%" }}
							textAlign="center"
							fontSize={{ lg: 30, base: 20 }}
							color="white"
							bg="orange">
							ЛЮБЫЕ УСЛУГИ ПО ПЕРЕВОЗКЕ! ДЕШЁВО, КАЧЕСТВЕННО, НАДЁЖНО! ПЕРЕЕЗДЫ
							ДОМОВ, ОФИСОВ
						</Text>
